...
<div class="card">
    <div class="card-header">Manage Karyawan</div>
    <div class="card-body">
        <a href="{{ route('mahasiswa.create') }}" class="btn btn-success btn-sm mb-3"><i class="bi bi-plus-circle"></i> Add New Karyawan</a>
